...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT 
            ...
            products.ImageURL, 
            MIN(productsizes.Price) AS MinPrice, 
            MAX(productsizes.Price) AS MaxPrice,
        ...
        LEFT JOIN 
            productsizes 
        ON 
            products.ProductID = productsizes.ProductID
        WHERE 
    ...
    $products = []; // If you are not logged in.
}
?>
<!DOCTYPE html>
<html lang="ar">
...
<body>
    <div class="container-fluid px-0">
        ...
        <div class="row px-5 py-4">
            <label for="" class="font-size-27px font-weight-600">Your favorite products!</label>
        </div>
        <div class="row px-5 margin-top-25px">              
              <?php if (empty($products)): ?>
                <p class="no-products text-center">There are no favorite products yet.</p>
             <?php else: ?>
